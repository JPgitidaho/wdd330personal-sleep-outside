  ...
  renderProductDetails(product) {
    ...
    if (
      ...
      clone.querySelector(".price").innerHTML =
        `<span style="text-decoration: line-through; color: #888;">$${product.SuggestedRetailPrice.toFixed(2)}</span>`;
      clone.querySelector(".final-price").innerHTML =
        `<span style="font-weight: bold; color: #b91c1c;">$${product.FinalPrice.toFixed(2)}</span>`;
